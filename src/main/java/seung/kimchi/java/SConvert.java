...
public class SConvert {
	 ...
	 * <h1>Description</h1>
	 * <pre>
	 * Available MessageDigest algorithm.
	 * Could add provider.
	 * </pre>
	 * <h1>Usage</h1>
	 * <pre>
	 * Security.addProvider(new BouncyCastleProvider());
	 * for(String algorithm : SConvert.availableMessageDigestAlgorithms()) {
	 *   System.out.println(algorithm);
	 * }
	 * </pre>
	 * <hr/>
	 * @see {@link Security#getAlgorithms(String)}
	 * @author seung
	 * @since 2020.12.21
	 * @version 1.0.0
	 */
	public static Set<String> availableMessageDigestAlgorithms() {
